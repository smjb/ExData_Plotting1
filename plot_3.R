...
plot(x=power_data$dt, y=power_data$Sub_metering_1, type="l", lwd=1, xlab="", ylab="Energy sub metering")
lines(x=power_data$dt, y=power_data$Sub_metering_2, col="red", lwd=1)
lines(x=power_data$dt, y=power_data$Sub_metering_3, col="blue", lwd=1)
